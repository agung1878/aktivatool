...
function lionthemes_vc_shortcodes() {
	...
	vc_add_params( 'vc_custom_heading', array(
		array(
			...
			'value' => '',
			'group' => esc_html__( 'homess options', 'lionthemes' ),
		 ),
		array(
			'type' => 'dropdown',
	...
	vc_map( array(
		...
		'base' => 'ourbrands',
		'class' => '',
		'category' => esc_html__( 'homess Theme', 'lionthemes'),
		'params' => array(
			array(
				'type' => 'textfield',
				'holder' => 'div',
	...
	vc_map( array(
		...
		'params' => array(
			...
			array(
				...
				'value' => array(
						esc_html__('Default', 'lionthemes')	=> '',
						esc_html__('Style 1', 'lionthemes')	=> 'style_1',
						esc_html__('Style 2', 'lionthemes')	=> 'style_2',
					),
			),
			array(
	...
	//Category List
	vc_map( array(
		'name' => esc_html__( 'Category list', 'lionthemes' ),
		'base' => 'categories',
		'class' => '',
		'category' => esc_html__( 'homess Theme', 'lionthemes'),
		'params' => array(
			...
			array(
				...
				'holder' => 'div',
				'class' => '',
				'heading' => esc_html__( 'Categories', 'lionthemes' ),
			...
			array(
				...
				'holder' => 'div',
				'class' => '',
				'heading' => esc_html__( 'Show on effect', 'lionthemes' ),
			...
			array(
				...
				'holder' => 'div',
				'class' => '',
				'heading' => esc_html__( 'Auto rotate', 'lionthemes' ),
				'param_name' => 'autoplay',
				'value' => array(
					esc_html__( 'No', 'lionthemes' ) 	=> 'false',
					esc_html__( 'Yes', 'lionthemes' ) 	=> 'true',
				),
				'save_always' => true,
				'group' => esc_html__( 'Carousel Options', 'lionthemes' ),
			),
			array(
				...
				'holder' => 'div',
				'class' => '',
				'heading' => esc_html__( 'Play Timeout', 'lionthemes' ),
			...
			array(
				...
				'holder' => 'div',
				'class' => '',
				'heading' => esc_html__( 'Rotate speed', 'lionthemes' ),
				'param_name' => 'speed',
				'value' => '250',
				'save_always' => true,
				'group' => esc_html__( 'Carousel Options', 'lionthemes' ),
	...
	//Category Gird
	vc_map( array(
		'name' => esc_html__( 'Category Gird', 'lionthemes' ),
		'base' => 'categoriesgird',
		'class' => '',
		'category' => esc_html__( 'homess Theme', 'lionthemes'),
		'params' => array(
			...
			array(
				...
				'param_name' => 'style',
				'value' => array(
						esc_html__( 'Grid 3', 'lionthemes' )	 	=> 'grid3',
						esc_html__( 'Grid 4', 'lionthemes' )	 	=> 'grid4',
						esc_html__( 'Grid 5', 'lionthemes' )	 	=> 'grid5',
						esc_html__( 'Grid 7', 'lionthemes' )	 	=> 'grid7',
					),
			),
			array(
				'type' => 'dropdown',
	...
	//Testimonials
	vc_map( array(
		'name' => esc_html__( 'homess Testimonials', 'lionthemes' ),
		'base' => 'testimonials',
		'class' => '',
		'category' => esc_html__( 'homess Theme', 'lionthemes'),
		'params' => array(
		...
		'params' => array(
			...
			array(
				...
				'value' => array(
						...
						esc_html__( 'Home 3', 'lionthemes' ) 		=> 'style_3',
						esc_html__( 'Home 4', 'lionthemes' ) 		=> 'style_4',
					),
			),
		)
	) );
		...
		'params' => array(
			...
			array(
				...
				'value' => array(
						...
						esc_html__( 'Rectangle', 'lionthemes' ) => 'rectangle',
					),
			),
			array(
				'type' => 'textfield',
			...
			array(
				...
				'value' => array(
						...
						esc_html__( 'Style 2', 'lionthemes' ) 		=> 'style_2',
						esc_html__( 'Style 3', 'lionthemes' ) 		=> 'style_3',
						esc_html__( 'Style 4', 'lionthemes' ) 		=> 'style_4',
					),
			),	
			array(
				'type' => 'textfield',
	...
	//Custom countdown
	vc_map( array(
		'name' => esc_html__( 'homess Countdown timer', 'lionthemes' ),
