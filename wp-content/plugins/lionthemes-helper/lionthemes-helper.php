...
add_action("redux/field/homess_opt/sortable/fieldset/after/homess_opt", 'lionthemes_helper_redux_add_placeholder_sortable', 0);
function lionthemes_helper_redux_add_placeholder_sortable($data){
	$fieldset_id = $data['id'] . '-list';
	$base_name = 'homess_opt['. $data['id'] .']';
...
add_action("redux/extensions/homess_opt/before", 'lionthemes_helper_redux_register_extension_loader', 0);
...
function lionthemes_helper_wbc_extended_example( $demo_active_import , $demo_directory_path ) {
	...
	if ( class_exists( 'RevSlider' ) ) {
		$wbc_sliders_array = array(
			'homess' => array('homess-slider-1.zip','homess-slider-2.zip','homess-slider-3.zip','homess-slider-4.zip','homess-slider-5.zip','home-page-6-slider.zip','home-page-7-slider.zip','home-page-8-slider.zip','home-page-9-slider.zip','home-page-10-slider.zip','home-page-11-slider.zip','home-page-12-slider.zip'),
		);
...
add_action("redux/homess_opt/panel/after", 'lionthemes_helper_redux_after_panel_gender', 0);
...
function lionthemes_like_button_html($id){
	...
	<div class="likes-counter" title="<?php echo (!$liked) ?  esc_html__('Like this post', 'homess') : esc_html__('Unlike this post', 'homess'); ?>" data-toggle="tooltip">
		<a class="lionthemes_like_post<?php echo ($liked) ? ' liked':''; ?>" href="javascript:void(0)" data-post_id="<?php echo $id; ?>" data-liked_title="<?php echo esc_html__('Unlike this post', 'homess') ?>" data-unliked_title="<?php echo esc_html__('Like this post', 'homess') ?>">
...
function lionthemes_view_count_button_html($id){
	?>
	<div class="post-views" title="<?php echo esc_html__('Total Views', 'homess') ?>" data-toggle="tooltip">
...
function lionthemes_product_sharing() {
	...
	if(isset($homess_opt['pro_social_share']) && is_array($homess_opt['pro_social_share'])){
		$pro_social_share = array_filter($homess_opt['pro_social_share']);
	}
	if(!empty($pro_social_share)){
		...
		<div class="social-sharing">
			<div class="widget widget_socialsharing_widget">
				<h3 class="widget-title"><?php if(isset($homess_opt['product_share_title'])) { echo esc_html($homess_opt['product_share_title']); } else { esc_html_e('Share this product', 'homess'); } ?></h3>
				<ul class="social-icons">
					<?php if(!empty($homess_opt['pro_social_share']['facebook'])){ ?>
						<li><a class="facebook social-icon" href="javascript:void(0)" onclick="javascript:window.open('<?php echo 'https://www.facebook.com/sharer/sharer.php?u='.$share_url; ?>', '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600'); return false;" title="<?php echo esc_attr__('Facebook', 'homess'); ?>"><i class="fa fa-facebook"></i></a></li>
					<?php } ?>
					<?php if(!empty($homess_opt['pro_social_share']['twitter'])){ ?>
						<li><a class="twitter social-icon" href="javascript:void(0)" onclick="javascript:window.open('<?php echo 'https://twitter.com/home?status='.$posttitle.'&nbsp;'.$share_url; ?>', '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600'); return false;" title="<?php echo esc_attr__('Twitter', 'homess'); ?>" ><i class="fa fa-twitter"></i></a></li>
					<?php } ?>
					<?php if(!empty($homess_opt['pro_social_share']['pinterest'])){ ?>
						<li><a class="pinterest social-icon" href="javascript:void(0)" onclick="javascript:window.open('<?php echo 'https://pinterest.com/pin/create/button/?url='.$share_url.'&amp;media='.$postimg.'&amp;description='.$posttitle; ?>', '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600'); return false;" title="<?php echo esc_attr__('Pinterest', 'homess'); ?>"><i class="fa fa-pinterest"></i></a></li>
					<?php } ?>
					<?php if(!empty($homess_opt['pro_social_share']['gplus'])){ ?>
					<li><a class="gplus social-icon" href="javascript:void(0)" onclick="javascript:window.open('<?php echo 'https://plus.google.com/share?url='.$share_url; ?>', '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600'); return false;" title="<?php echo esc_attr__('Google +', 'homess'); ?>"><i class="fa fa-google-plus"></i></a></li>
					<?php } ?>
					<?php if(!empty($homess_opt['pro_social_share']['linkedin'])){ ?>
						<li><a class="linkedin social-icon" href="javascript:void(0)" onclick="javascript:window.open('<?php echo 'https://www.linkedin.com/shareArticle?mini=true&amp;url='.$share_url.'&amp;title='.$posttitle; ?>', '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600'); return false;" title="<?php echo esc_attr__('LinkedIn', 'homess'); ?>"><i class="fa fa-linkedin"></i></a></li>
					<?php } ?>
				</ul>
			</div>
		</div>
...
add_action('lionthemes_post_social_share', 'lionthemes_post_social_share_html');
function lionthemes_post_social_share_html($postid){
	$blog_social_share = array();
	global $homess_opt;
	if(isset($homess_opt['blog_social_share']) && is_array($homess_opt['blog_social_share'])){
		$blog_social_share = array_filter($homess_opt['blog_social_share']);
	}
	...
	<div class="social-sharing">
		<div class="widget widget_socialsharing_widget">
			<span><?php echo (esc_html__('Share to friends:', 'homess')) ?></span>
			<ul class="social-icons">
				<?php if(!empty($homess_opt['blog_social_share']['facebook'])){ ?>
				<li><a class="facebook social-icon" href="javascript:void(0)" onclick="javascript:window.open('<?php echo 'https://www.facebook.com/sharer/sharer.php?u='.$share_url; ?>', '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600'); return false;" title="<?php echo esc_attr__('Facebook', 'juston'); ?>"><i class="fa fa-facebook"></i></a></li>
				<?php } ?>
				<?php if(!empty($homess_opt['blog_social_share']['twitter'])){ ?>
				<li><a class="twitter social-icon" href="javascript:void(0)" onclick="javascript:window.open('<?php echo 'https://twitter.com/home?status='.$posttitle.'&nbsp;'.$share_url; ?>', '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600'); return false;" title="<?php echo esc_attr__('Twitter', 'juston'); ?>"><i class="fa fa-twitter"></i></a></li>
				<?php } ?>
				<?php if(!empty($homess_opt['blog_social_share']['pinterest'])){ ?>
				<li><a class="pinterest social-icon" href="javascript:void(0)" onclick="javascript:window.open('<?php echo 'https://pinterest.com/pin/create/button/?url='.$share_url.'&amp;media='.$postimg.'&amp;description='.$posttitle; ?>', '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600'); return false;" title="<?php echo esc_attr__('Pinterest', 'juston'); ?>"><i class="fa fa-pinterest"></i></a></li>
				<?php } ?>
				<?php if(!empty($homess_opt['blog_social_share']['gplus'])){ ?>
				<li><a class="gplus social-icon" href="javascript:void(0)" onclick="javascript:window.open('<?php echo 'https://plus.google.com/share?url='.$share_url; ?>', '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600'); return false;" title="<?php echo esc_attr__('Google +', 'juston'); ?>"><i class="fa fa-google-plus"></i></a></li>
				<?php } ?>
				<?php if(!empty($homess_opt['blog_social_share']['linkedin'])){ ?>
				<li><a class="linkedin social-icon" href="javascript:void(0)" onclick="javascript:window.open('<?php echo 'https://www.linkedin.com/shareArticle?mini=true&amp;url='.$share_url.'&amp;title='.$posttitle; ?>', '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600'); return false;" title="<?php echo esc_attr__('LinkedIn', 'juston'); ?>"><i class="fa fa-linkedin"></i></a></li>
				<?php } ?>
			</ul>
		</div>
	</div>
...
function lionthemes_page_banner_html(){
	...
	if($lionthemes_banner){
		...
		echo '<div class="custom-page"><div class="container"><div class="page-banner"><div class="page-banner-content">
		<h1 class="entry-title">'. $page_heading .'</h1>';
		homess_breadcrumb();
...
function lionthemes_popup_onload(){
	global $homess_opt;
	if(!empty($homess_opt['enable_popup'])) {
		if (is_front_page() && (!empty($homess_opt['popup_onload_form']) || !empty($homess_opt['popup_onload_content']))) {
			$no_again = 0; 
			...
			<div class="popup-content" id="popup_onload">
				...
				<div class="popup-content-wrapper">
					...
					<div class="popup-container">
						<div class="row">
							<div class="col-sm-6 hidden-xs col-img">
							</div>
							<div class="col-sm-6 col-xs-12 col-content pull-right">
								<div class="pup-up-center">
									<?php if(!empty($homess_opt['popup_onload_content'])){ ?>
									<div class="popup-content-text">
										<?php echo ''. $homess_opt['popup_onload_content']; ?>
									</div>
									<?php } ?>
									<?php if(!empty($homess_opt['popup_onload_form']) && shortcode_exists('mc4wp_form')){ ?>
									<div class="newletter-form">
										<?php echo do_shortcode( '[mc4wp_form id="'. intval($homess_opt['popup_onload_form']) .'"]' ); ?>
									</div>
									<?php } ?>							
									<label class="not-again"><input type="checkbox" value="1" name="not-again" /><span><?php echo esc_html__('Do not show this popup again', 'homess'); ?></span></label>
								</div>
							</div>
						</div>
					</div>
