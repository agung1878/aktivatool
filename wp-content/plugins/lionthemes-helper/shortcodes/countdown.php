<?php
function homess_countdown_shortcode( $atts ) {
	global $homess_opt;
		...
		<div class="deals-countdown">
			<span class="countdown-row">
				<span class="countdown-section">
					...
					<span class="countdown-label"><?php echo esc_html__('Days', 'homess'); ?></span>
				</span>
				<span class="countdown-section">
					<span class="countdown-val hours_left"><?php echo $hours_left; ?></span>
					<span class="countdown-label"><?php echo esc_html__('Hrs', 'homess'); ?></span>
				</span>
				<span class="countdown-section">
					<span class="countdown-val mins_left"><?php echo $mins_left; ?></span>
					<span class="countdown-label"><?php echo esc_html__('Mins', 'homess'); ?></span>
				</span>
				<span class="countdown-section">
					<span class="countdown-val secs_left"><?php echo $secs_left; ?></span>
					<span class="countdown-label"><?php echo esc_html__('Secs', 'homess'); ?></span>
				</span>
			</span>
		</div>
	<?php } 
...
add_shortcode( 'homess_countdown', 'homess_countdown_shortcode' );
?>