<?php
function homess_testimonials_shortcode( $atts ) {
				...
				<?php $i=0; while($query->have_posts()): $query->the_post(); $i++; ?>
					...
					<div class="quote">
						...
						<div class="author-avatar">							
							...
							<p class="byline">
							<span> - </span><?php echo get_post_meta(get_the_ID(), '_byline', true); ?>
							</p>
							<?php } ?>
...
add_shortcode( 'testimonials', 'homess_testimonials_shortcode' );
?>